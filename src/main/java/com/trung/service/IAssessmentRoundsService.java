...
public interface IAssessmentRoundsService {
    ApiResponse<AssessmentRoundsResponse> createAssessmentRound(AssessmentRoundCreateRequest request) throws ResourceNotFoundException, InvalidDateFormatException, ResourceConflictException;
    ...
    ApiResponse<AssessmentRoundsResponse> getAssessmentRoundById(Long id) throws ResourceNotFoundException;
     ApiResponse<AssessmentRoundsResponse> updateAssessmentRound(Long id, AssessmentRoundUpdateRequest request) throws ResourceNotFoundException, InvalidDateFormatException, ResourceConflictException, ResourceBadRequestException;
